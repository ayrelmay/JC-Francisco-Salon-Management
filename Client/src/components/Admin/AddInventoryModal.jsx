        ...
        <div className="space-y-6">
          ...
          <form className="space-y-5">
            ...
            <div>
              ...
              <select className="w-full px-4 py-2 text-sm border border-Tableline border-opacity-50 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 appearance-none bg-white">
            ...
            <div className="flex gap-4 pt-2 -mx-6 px-6">
              ...
              <PrimaryBtn type="button">Confirm</PrimaryBtn>
            </div>
          </form>
        </div>
      </div>
